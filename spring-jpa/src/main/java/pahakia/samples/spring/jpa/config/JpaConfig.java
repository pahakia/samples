package pahakia.samples.spring.jpa.config;
...
@ComponentScan({ "pahakia.samples.spring.jpa.*" })
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.pahakia.model" });
    ...
    Properties additionalProperties() {
        ...
        properties.setProperty("javax.persistence.jdbc.url", "jdbc:derby:target/test;create=true");
