...
/**
 * Upgrade given auth code to token, and store it in the session. POST body of request should be the authorization code.
 * Example URI: /connect?state=...&gplus_id=...
 */
public class ConnectServlet extends Signin {
